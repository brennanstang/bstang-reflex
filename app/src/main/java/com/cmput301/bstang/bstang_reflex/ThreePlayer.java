...
public class ThreePlayer extends Activity {
    ...
    public static ArrayList<String> threeStats = new ArrayList<>();
    int player1 = 0;
    int player2 = 0;
    int player3 = 0;
    ...
    private OnClickListener statsListener = new OnClickListener() {
        public void onClick(View v) {
            threeStats.add("Player one clicked: " + String.valueOf(player1));
            threeStats.add("Player two clicked: " +String.valueOf(player2));
            threeStats.add("Player three clicked: " + String.valueOf(player3));
